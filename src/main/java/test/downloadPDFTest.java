...
public class downloadPDFTest {
    public static void main(String[] args) {
        ...
        try {
            PdfWriter.getInstance(document, new FileOutputStream("D:\\费用报销单.PDF"));

            //设置字体
            BaseFont bfChinese = BaseFont.createFont("STSong-Light", "UniGB-UCS2-H",BaseFont.NOT_EMBEDDED);
            com.itextpdf.text.Font FontChinese24 = new com.itextpdf.text.Font(bfChinese, 15, com.itextpdf.text.Font.BOLD);
            ...
            String imagePath2 = "D:\\alibaba.jpg";
